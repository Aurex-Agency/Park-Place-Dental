...
**Read this first.** This is the handoff doc for picking up this project cold. Last updated 2026-08-23, end of the Phase 3 hero-and-homepage pass (`hero-stone-to-life`, not yet merged/PR'd as of this writing).
...
Interior page content (About, Services, New Patients, Smile Gallery, Contact, Emergency Dentist) replacing today's stubs, per KICKOFF-PROMPT.md. Also open: the deployed-LCP measurement noted above, the real hero headline/subhead copy (currently bracket placeholders, Kalob's to write), and the still-unresolved root cause of the shell's Render Delay (Phase 3 performance revisits, above) — worth another dedicated investigation pass before launch prep, not blocking Phase 4 content work.
