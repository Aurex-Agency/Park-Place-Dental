 ...
 * all raster images) handles the actual <img>. useInView watches this
 * untransformed outer span, not the animated motion.div — see the identical
 * fix in split-reveal.tsx for why that distinction matters.
 */
